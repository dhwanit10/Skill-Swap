        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/how-it-works" className="text-gray-300 hover:text-secondary-400 transition-colors">
                  How it Works
                </Link>
              </li>
              <li>
                <Link to="/browse-skills" className="text-gray-300 hover:text-secondary-400 transition-colors">
                  Browse Skills
                </Link>
              </li>
              <li>
                <Link to="/login" className="text-gray-300 hover:text-secondary-400 transition-colors">
                  Login/SignUp
                </Link>
              </li>
            </ul>
